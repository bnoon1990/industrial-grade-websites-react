function Header() {
    return (
        <header>
            ...
            <div
                class="px-6 py-20 text-center text-neutral-800 dark:bg-neutral-700 dark:text-neutral-200
                bg-gradient-to-r from-yellow-500 via-yellow-100 to-yellow-600">
                <h1 class="mb-6 text-8xl font-bold text-gray-600 uppercase">Industrial Grade Websites</h1>
            </div>
        </header>
    )
}
